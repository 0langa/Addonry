...
def default_output_root(home: Path | None = None) -> Path:
    ...
    if source_repos.is_dir():
        return source_repos / "chrome-extensions"
    return user_home / "chrome-extensions"
...
Personal unpacked Chrome extension generated by Addonry in durable user storage.

## Install or update

For persistent Google Chrome installation, open `chrome://extensions`, enable
Developer Mode, choose **Load unpacked**, and select this directory. Official
Google Chrome 137+ ignores command-line unpacked-extension loading. Addonry's
guarded restart helper is only for supported isolated Chromium or Chrome for
Testing profiles.

## Verify

Run Addonry static validator, tailored real-Chrome E2E scenario, Chrome DevTools
MCP inspection, and `--final-ready` evidence gate before use.
"""
