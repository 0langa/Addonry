...
Read [cross-browser-architecture.md](../skills/create-chrome-extension/references/cross-browser-architecture.md) for relevant API family. Consult [official-sources.md](../skills/create-chrome-extension/references/official-sources.md) whenever API shape, browser support, install behavior, packaging, or provider configuration is uncertain. Prefer browser-vendor and provider primary sources.
...
Read [packaging.md](../skills/create-chrome-extension/references/packaging.md), then run only after release-ready validation:
...
- [cross-browser-architecture.md](../skills/create-chrome-extension/references/cross-browser-architecture.md)
...
- [quality-loop.md](../skills/create-chrome-extension/references/quality-loop.md)
- [installation.md](../skills/create-chrome-extension/references/installation.md)
- [packaging.md](../skills/create-chrome-extension/references/packaging.md)
